...
class Program
{
    static void Main(string[] args)
    {
        ...
        Video vid1 = new Video("Sakanaction / Kaiju -Music Video-", "サカナクション sakanaction", 289);
        ...
        vid1.AddComment(new Comment("なめ茸", "The fact that Chi ends up giving the egg to someone she doesn't know is connected to the 'inheritance' depicted in the story."));
